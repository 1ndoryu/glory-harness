/* [139A-8 F4/S1] Contrato `AgentTool` + `AgentToolRegistry` (extraído de
...
use super::contexto::AgentToolContext;
use super::resultado::AgentToolResult;
