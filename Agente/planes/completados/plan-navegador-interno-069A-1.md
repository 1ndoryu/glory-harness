...
- **Estado:** ✦ F1 y F2 completados y validados funcionalmente (06-09-2026). El plan se cierra: F1–F2 son el bloque técnico base; F3–F6 quedan diferidas como tareas separadas al requerir panel UI, overlay de anotaciones y tool del núcleo.
